...
export const DetailedWeatherView = () => {
  ...
  const loading = useSelector((state) => state?.weather?.loading); // optional if you have a loading state
        ...
        {isLoading ? (
          ...
          <>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-8 text-black">
              <Card className="glass-panel p-6 col-span-1 sm:col-span-2 lg:col-span-1">
                <div className="text-center">
                  <div className="text-6xl font-bold text-gray-800 mb-2">
                    {weatherData?.temp_c}°C
                  </div>
                  <div className="mb-4 flex justify-center gap-4 text-gray-800 font-bold">
              ...
              <Card className="glass-panel p-6 col-span-1 sm:col-span-2 lg:col-span-2">
